  ...
  return (
    <>
        <div className={`fixed z-50 top-0 w-full h-[6%] ${active === "/gallery" ? "bg-black" : active === "/shikasletter" ? "bg-white" : "bg-[#1e2d42]"} flex items-center justify-center`}>
          ...
          <div className={`${toggle ? "visible" : "hidden"} absolute md:hidden right-3 top-14 h-[120px] p-2 py-5 flex flex-col items-center justify-evenly  text-white uppercase text-[10px] w-[120px] border-2 border-white border-solid ${active === "/gallery" && "bg-black"} bg-[#1e2d42]`}>
